...
logging.basicConfig(filename=db_log,
                    level=logging.DEBUG,
...
def main():
    ...
    ##PROD################################################# umieszczone w cron
        ...
        pass  # TODO dodać obsługę błędu i logowanie


def timestamp2time(ts):
    # jeśli to nie jest INT to konwertuj na INT
...
def continiousreading(data):
    ...
    for k in range(0, len(kolumna_danych)):  #przechodzimy przez wszystkie zczytane dane -k jest od 0 do długości zmiennej: kolumna_danych
        ...
        table_name = str(kolumna_danych[k]) #zmienna przechowująca nazwę tabeli
